...
struct motorStruct // Структура для локального управления и сбора данных по моторам
{
  ...
  float angleError;          // Ошибка по положению между текущим положением и заданным
  float angleSpeed;          // Разница по заданному углу между текущим и предыдущим. Типа угловая скорость вращения мотора
